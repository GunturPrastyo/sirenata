...
<li>
    <a href="{{ route('user.my-course') }}"
        class="flex items-center px-2 py-1.5 {{ request()->routeIs('user.my-course') ? 'text-indigo-600 bg-purple-100' : 'text-gray-500 hover:bg-purple-100 hover:text-indigo-600' }} rounded-lg group transition-colors">
        <svg class="shrink-0 w-5 h-5 transition duration-75 {{ request()->routeIs('user.my-course') ? 'text-indigo-600' : 'group-hover:text-indigo-600' }}" aria-hidden="true"
