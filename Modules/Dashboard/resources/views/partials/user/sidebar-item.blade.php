<ul class="space-y-1.5 px-3 font-medium text-sm">
    ...
    <li>
        <a href="{{ route('user.dashboard') }}"
            ...
            <svg class="w-5 h-5 shrink-0 transition duration-75 {{ request()->routeIs('user.dashboard') ? 'text-[#13416B]' : 'group-hover:text-[#13416B]' }}"
    ...
    <li>
        <a href="{{ route('user.course.my-course') }}"
            ...
            <span class="ms-3 text-sm">Kursus Saya</span>
        </a>
    </li>
    ...
    <li>
        <a href="#"
            class="flex items-center px-3 py-2.5 rounded-lg text-gray-600 hover:bg-[#13416B]/10 hover:text-[#13416B] transition-colors group">
            ...
            <span class="flex-1 ms-3 whitespace-nowrap text-sm">Katalog</span>
        </a>
    </li>
    ...
    <li>
        <a href="{{ route('user.library.index') }}"
            ...
            <span class="flex-1 ms-3 whitespace-nowrap text-sm">Perpustakaan</span>
        </a>
    </li>
    ...
    <li>
        <a href="{{ route('user.kalkulator.sandbox') }}" target="_blank"
            ...
            <span class="flex-1 ms-3 whitespace-nowrap text-sm">Kalkulator RTK</span>
            <svg class="w-3.5 h-3.5 text-gray-400 group-hover:text-[#13416B]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <li>
        <a href="{{ route('user.tim-kerja.index') }}"
            ...
            <span class="flex-1 ms-3 whitespace-nowrap text-sm">Tim Kerja</span>
        </a>
    </li>
    @endif
    ...
    <li>
        <a href="{{ route('user.help') }}"
            ...
            <span class="flex-1 ms-3 whitespace-nowrap text-sm">Bantuan</span>
        </a>
    </li>
</ul>