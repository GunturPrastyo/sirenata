<ul class="space-y-3 px-3 font-medium text-sm">
    ...
    <li>
        <a href="{{ route('admin-pusat.rekapitulasi.index') }}"
            ...
            <span class="flex-1 ms-3.5 whitespace-nowrap">Rekapitulasi SDM</span>
        </a>
    </li>
    ...
    <li x-data="{ open: {{ request()->routeIs('admin-pusat.survey-periods.*', 'admin-pusat.hasil-pemanfaatan-rtkd.*') ? 'true' : 'false' }} }">
        <button @click="open = !open"
            ...
            {{ request()->routeIs('admin-pusat.survey-periods.*', 'admin-pusat.hasil-pemanfaatan-rtkd.*')
                ? 'text-[#13416B] bg-slate-200/70 font-bold'
                : 'text-slate-600 hover:bg-slate-100 hover:text-[#13416B]' }}">
            <svg class="w-[22px] h-[22px] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
            </svg>
            <span class="flex-1 ms-3.5 text-left">Pemanfaatan RTKD</span>
            <svg class="w-4 h-4 transition-transform duration-200" :class="{ 'rotate-180': open }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 9-7 7-7-7" />
            </svg>
        </button>
    ...
    <li>
        <a href="{{ route('admin-pusat.management-course.courses.index') }}"
            ...
            {{ request()->routeIs('admin-pusat.management-course*')
                ? 'text-[#13416B] bg-slate-200/70 font-bold'
                : 'text-slate-600 hover:bg-slate-100 hover:text-[#13416B]' }}">
            <svg class="w-[22px] h-[22px] shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <rect x="3" y="5" width="18" height="14" rx="2" />
                <path d="M7 9h4" />
                <path d="M7 12h2" />
                <circle cx="16" cy="12" r="2.5" />
            </svg>
            <span class="ms-3.5">Management Course</span>
        </a>
    </li>

    <!-- Perpustakaan (Single Menu) -->
    <li>
        <a href="{{ route('admin-pusat.libraries.index') }}"
            ...
            <span class="ms-3.5">Perpustakaan</span>
        </a>
    </li>
    ...
    <li>
        <a href="{{ route('admin-pusat.certificates.index') }}"
            ...
            <span class="ms-3.5">Sertifikat</span>
        </a>
    </li>
</ul>