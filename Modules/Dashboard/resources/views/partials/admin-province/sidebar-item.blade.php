...
<li
    ...
    <ul x-show="open" x-collapse class="mt-1 space-y-1">
        <li>
            <a href="{{ route('admin-province.laporan.index') }}" class="flex items-center pl-10 px-2 py-1.5 rounded-md transition text-sm
    ...
    : 'text-gray-600 hover:bg-purple-100 hover:text-indigo-600' }}">
        ...
        <li>
            <a href="{{ route('admin-province.rtkdp.index') }}" class="flex items-center pl-10 px-2 py-1.5 rounded-md transition text-sm
