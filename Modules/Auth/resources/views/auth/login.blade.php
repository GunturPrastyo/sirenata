        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0 ">
            ...
            <div class="w-full bg-white rounded-lg shadow-2xl  md:mt-0 sm:max-w-md xl:p-0">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form method="POST" action="{{ route('authenticate') }}"  class="space-y-4 md:space-y-6" >
                        @csrf
                        <div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="#" class="text-sm font-medium text-neutral-600 hover:underline ">Forgot password?</a>
                        </div>
