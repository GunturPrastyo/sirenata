<x-dashboard::layouts.dashboard title="Tambah Tipe Perpustakaan - E-Learning">
    <div class="p-2 sm:p-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-8 max-w-2xl mx-auto border border-gray-100">
            <div class="mb-4 sm:mb-6">
                <h1 class="text-lg sm:text-2xl font-bold text-gray-900">Tambah Tipe Perpustakaan</h1>
                <p class="text-gray-600 mt-1 text-sm sm:text-base">Masukkan nama tipe perpustakaan baru (contoh: Ebook,
                    Peraturan, Video).</p>
            ...
            <form action="{{ route('admin-pusat.library-types.store') }}" method="POST" class="space-y-4 sm:space-y-6">
                @csrf
                <div>
