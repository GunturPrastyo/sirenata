        ...
        <div class="max-w-full mx-auto bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Bagian: <span
                            class="font-medium text-slate-700">{{ $section->name }}</span></p>
                </div>
                <a href="{{ route('admin-pusat.management-course.courses.show', $course->slug) }}"
            ...
            <form action="{{ route('admin-pusat.management-course.course-sections-contents.store') }}" method="POST"
                ...
                <div>
                    ...
                    <input type="url" id="video" name="video" value="{{ old('video') }}"
                ...
                <div>
                    ...
                    <div class="prose max-w-none bg-white">
                        <!-- Hidden input WAJIB ada atribut name="content_text" -->
