<x-dashboard::layouts.dashboard title="Rekapitulasi User Kab/Kota">
    <div class="p-2 sm:p-6">
        ...
        <x-breadcrumb :home="route('admin-pusat.dashboard')" :items="[
            ...
            ['label' => 'Kab/Kota', 'url' => route('admin-pusat.rekapitulasi.kab-kota', $regency->province_code)],
            ['label' => 'User ' . $regency->name]
        ]" />
        ...
        <x-dashboard::filter-card 
            ...
            <x-slot name="actions">
                <x-button :href="route('admin-pusat.rekapitulasi.rekap-user-kab-kota.export', $regencyCode) . '?' . http_build_query(request()->only(['search', 'course_id']))" 
