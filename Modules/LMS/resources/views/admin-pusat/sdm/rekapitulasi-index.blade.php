<x-dashboard::layouts.dashboard title="Rekapitulasi Provinsi">
    <div class="p-2 sm:p-6 pt-6 sm:pt-8">
        ...
        <x-breadcrumb :home="route('admin-pusat.dashboard')" :items="[['label' => 'Rekapitulasi Provinsi']]" />
        ...
        <x-dashboard::filter-card 
            title="Rekapitulasi SDM Provinsi" 
            :total="$data->total() . ' Provinsi'"
            :resetUrl="route('admin-pusat.rekapitulasi.index')">
            ...
            <x-table.table plain>
                <thead>
                    <tr>
                        ...
                        <x-table.th>Nama Provinsi</x-table.th>
