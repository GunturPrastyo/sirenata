<x-dashboard::layouts.dashboard title="Tambah Course">
    <div class="p-2 sm:p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <form action="{{ route('admin-pusat.management-course.courses.store') }}" method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Nama Course -->
                    <div class="col-span-1 md:col-span-2">
                        <x-form.input name="name" label="Nama Course" placeholder="Contoh: Perencanaan Tenaga Kerja"
                            required />
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2 space-y-4" x-data="{ mode: 'auto' }">
                        ...
                        <div class="flex items-center gap-4">
                            <label class="flex items-center gap-2 cursor-pointer text-xs font-semibold text-slate-700">
                                ...
                                <span>Otomatis (Inisial & Warna Tema)</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer text-xs font-semibold text-slate-700">
                        ...
                        <div x-show="mode === 'auto'"
                            ...
                            <p class="text-[11px] text-slate-500 font-medium">Sistem akan otomatis merender thumbnail
                                dengan inisial nama kursus dan warna pilihan di atas.</p>
                        </div>
                        ...
                        <div x-show="mode === 'upload'" class="p-4 bg-slate-50 rounded-xl border border-slate-200">
                            ...
                            <p class="text-[11px] text-slate-500 mt-2 font-medium">Unggah gambar dengan format JPG, PNG,
                                atau WEBP (Maks. 2MB).</p>
                        </div>
                    </div>

                    <!-- Deskripsi -->
                    <div class="col-span-1 md:col-span-2">
                        <x-form.textarea name="description" label="Deskripsi Course" rows="5"
