<x-dashboard::layouts.dashboard title="Daftar Permission">
    <div class="p-2 sm:p-6">
            ...
            <ol class="inline-flex items-center space-x-1">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2">Daftar Permission</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <a href="{{ route('super-admin.permissions.create') }}"
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-1">
                        Total: <span class="font-medium text-slate-700"
                            id="total-admin">{{ $permissions->total() }}</span>
                        permission
                    </p>
                </div>
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-slate-100 border-b border-slate-200">
                        <tr class="text-slate-500 uppercase text-xs">
                            ...
                            <th class="px-4 md:px-6 py-3 text-left">Nama Permission</th>
                        ...
                        @forelse ($permissions as $key => $permission)
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-4 md:px-6 py-3 text-center">
                                    <x-table.action>
                                        <li>
                                            <a href="{{ route('super-admin.permissions.edit', $permission->uuid) }}"
