    ...
    <div class="p-2 sm:p-6">
            ...
            <ol class="inline-flex items-center space-x-1">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2">Lembaga</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 bg-slate-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 class="text-base font-semibold text-slate-800">Daftar Lembaga</h2>
                    <p class="text-sm text-slate-500 mt-1">
                        Total: <span class="font-medium text-slate-700">{{ $institutions->total() }}</span> Lembaga
                    </p>
                </div>

                <div class="flex items-center gap-2">
                    <button type="button" x-data @click="$dispatch('open-modal', 'create-lembaga')"
                ...
                <table class="min-w-full text-sm">
                    <thead class="bg-slate-100 border-b border-slate-200">
                        <tr class="text-slate-500 uppercase text-xs text-left">
                            ...
                            <th class="px-4 py-3">Nama Lembaga / Kementerian</th>
                                ...
                                <form action="{{ route('super-admin.lembaga.update', $instansi->id) }}" method="POST" class="space-y-4 text-left">
                                    ...
                                    <div>
                                        <label for="name-{{ $instansi->id }}" class="block text-sm font-medium text-gray-700 mb-1">
                                            Nama Lembaga (Pusat) <span class="text-red-500">*</span>
                                        </label>
