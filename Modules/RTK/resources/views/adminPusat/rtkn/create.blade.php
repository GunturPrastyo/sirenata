<x-dashboard::layouts.dashboard title="Upload Rencana Tenaga Kerja Nasional">
    <div class="p-2 sm:p-6  pt-6 sm:pt-8">
        ...
        <div class="bg-white rounded-md shadow-sm p-10 mt-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    <form action="{{ route('admin-pusat.rtkn.store') }}" method="POST" id="uploadForm"
                        ...
                        @csrf
                        <!-- Nama -->
                        <x-form.input name="name" label="Nama" required placeholder="Masukkan nama dokumen Rencana Tenaga Kerja Nasional" />
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Upload Dokumen Rencana Tenaga Kerja Nasional <span class="text-red-500">*</span>
                            </label>
