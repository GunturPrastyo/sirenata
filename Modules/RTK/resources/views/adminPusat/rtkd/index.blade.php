    ...
    <div class="p-2 sm:p-6">
        ...
        <form method="GET" class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 mb-6">
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
                ...
                <div class="flex gap-2 w-full lg:w-96 shrink-0">
                    ...
                    <a
                        href="{{ route('admin-pusat.rtkd.index') }}"
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-200 bg-slate-50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <a href="{{ route('admin-pusat.rtkd.export-all-province') }}?{{ http_build_query(request()->only(['search', 'status_verification', 'status_document', 'acuan'])) }}"
                    ...
                    <span class="hidden sm:inline">Export All Province</span>
                </a>
            </div>
                        ...
                        @forelse ($rtkds as $key => $province)
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-4 md:px-6 py-3 text-center">
                                    @if ($province->latest_rtk)
                                        <span class="px-2.5 py-1 text-xs rounded-full font-semibold {{ $province->latest_rtk->status_verification_color }}">
                                ...
                                <td class="px-4 md:px-6 py-3 text-center">
                                    @if ($province->latest_rtk)
                                        <span class="px-2.5 py-1 text-xs rounded-full font-semibold {{ $province->latest_rtk->status_document_color }}">
