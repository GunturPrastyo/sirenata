        ...
        <form method="GET" class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 mb-6">
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
                ...
                <div class="flex gap-2 w-full lg:w-72 shrink-0">
                    ...
                    <a
                        href="{{ route('admin-pusat.rtkd.show-regency', $regencyCode) }}"
                                            ...
                                            <li class="mb-2">
                                                ...
                                                <x-modal name="approve-doc-rtk-{{ $rtk->id }}"
                                                    ...
                                                    <div class="p-6 text-center">
                                                        ...
                                                        <form action="{{ route('admin-pusat.rtkd.approveDocumentKabKota', $rtk->id) }}" method="POST" class="flex justify-center gap-3">
                                                            @csrf
                                                            <button type="submit"
                                            ...
                                            <li class="mb-2">
                                                ...
                                                <x-modal name="reject-rtk-{{ $rtk->id }}" title="Konfirmasi Penolakan RTK"
                                                    ...
                                                    <div class="p-6">
                                                        ...
                                                        <form action="{{ route('admin-pusat.rtkd.rejectKabKota', $rtk->id) }}"
