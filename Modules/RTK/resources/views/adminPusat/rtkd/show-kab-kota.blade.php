        ...
        <div class="mb-8">
            <x-breadcrumb :home="route('admin-pusat.dashboard')" :items="[
                ...
                [
                    ...
                    'url' => route('admin-pusat.rtkd.kab-kota', $regency->province_code),
                ],
                ['label' => 'Daftar Laporan RTK ' . $regency->name],
            ]" />
        </div>

        <x-dashboard::filter-card title="Daftar Laporan RTK {{ $regency->name }}" :total="$rtks->total() . ' Dokumen RTK'" :resetUrl="route('admin-pusat.rtkd.show-regency', $regencyCode)">

            <x-slot name="actions">
                <x-button
                    href="{{ route('admin-pusat.rtkd.show-regency-export', $regencyCode) }}?{{ http_build_query(request()->only(['search', 'status_document', 'status_verification', 'acuan'])) }}"
                    ...
                    @forelse ($rtks as $key => $rtk)
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <x-table.td>
                                @php
                                    $verifColor = match (
                                        $rtk->status_verification->value ?? $rtk->status_verification
                                    ) {
                                        ...
                                        <li class="mb-2">
                                            ...
                                            <x-modal name="approve-rtk-{{ $rtk->id }}"
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <form
                                                        action="{{ route('admin-pusat.rtkd.approveVerificationKabKota', $rtk->id) }}"
                                        ...
                                        <li class="mb-2">
                                            ...
                                            <x-modal name="approve-doc-rtk-{{ $rtk->id }}"
                                                ...
                                                <div class="p-6 text-center">
                                                    ...
                                                    <form
                                                        action="{{ route('admin-pusat.rtkd.approveDocumentKabKota', $rtk->id) }}"
                                                        method="POST" class="flex justify-center gap-3">
                                                        @csrf
                                                        <button type="submit"
                                        ...
                                        <li class="mb-2">
                                            ...
                                            <x-modal name="reject-rtk-{{ $rtk->id }}"
                                                ...
                                                <div class="p-6">
                                                    ...
                                                    <form
                                                        action="{{ route('admin-pusat.rtkd.rejectKabKota', $rtk->id) }}"
