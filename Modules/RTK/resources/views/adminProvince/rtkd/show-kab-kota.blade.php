        ...
        <form method="GET" class="bg-white rounded-xl border border-slate-200 shadow-sm p-5 mb-6">
            <div class="flex flex-col lg:flex-row lg:items-end justify-between gap-4">
                ...
                <div class="flex gap-2 w-full lg:w-72 shrink-0">
                    ...
                    <a
                        href="{{ route('admin-province.laporan.show-regency', $regencyCode) }}"
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div
                ...
                <div class="flex items-center gap-2">
                    <a
                        href="{{ route('admin-province.laporan.export-regency', $regencyCode) }}?{{ http_build_query(request()->only(['search', 'status_document', 'status_verification', 'acuan'])) }}"
