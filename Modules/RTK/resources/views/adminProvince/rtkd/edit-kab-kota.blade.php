    ...
    <div class="p-2 sm:p-6">
            ...
            <ol class="inline-flex items-center space-x-1">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin-province.laporan.show-regency', $regency->code) }}"
                            class="ml-1 text-sm font-medium text-gray-700 hover:text-indigo-600 md:ml-2">RTK
                            {{ $regency->name }}
                        </a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit RTK {{ $regency->name }}</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-md shadow-sm p-10">
            <div class="grid grid-cols-1 lg:grid-cols-1 gap-8">
                <!-- Left Column: Form -->
                <div>
                    <form action="{{ route('admin-province.laporan.update-regency', ['regencyCode' => $regency->code, 'rtkdp' => $rtkdp->id]) }}" method="POST" id="uploadForm" class="space-y-8" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <!-- Nama -->
                        <div>
