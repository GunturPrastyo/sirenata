                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin-province.rtkdp.index') }}"
                            ...
                            Rekapitulasi Rencana Tenaga Kerja Daerah Provinsi
                        </a>
                    </div>
                </li>
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">
                            Upload Rencana Tenaga Kerja Daerah Provinsi
                        </span>
                    </div>
                </li>
            </ol>
                    ...
                    <form action="{{ route('admin-province.rtkdp.store') }}" method="POST" id="uploadForm"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Upload Dokumen Rencana Tenaga Kerja Daerah Provinsi <span class="text-red-500">*</span>
                            </label>
