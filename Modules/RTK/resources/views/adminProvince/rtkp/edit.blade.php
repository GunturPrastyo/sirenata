<x-dashboard::layouts.dashboard title="Rencana Tenaga Kerja Daerah Provinsi Edit">
    <div class="p-2 sm:p-6">
        ...
        <x-breadcrumb :items="[
            ['label' => 'Rekapitulasi Rencana Tenaga Kerja Provinsi', 'url' => route('admin-province.rtkdp.index')],
            ['label' => 'Edit RTKP']
        ]" />
        ...
        <div class="">
            <x-button type="button" x-data @click="$dispatch('open-modal', 'preview-document')" variant="white" class="mb-3">
            ...
            <x-modal name="preview-document" title="Pratinjau Dokumen Saat Ini" maxWidth="sm:max-w-2xl">
                ...
                <x-slot:footer>
                    <x-button @click="$dispatch('close-modal', 'preview-document')" variant="white">
                        Close
                    </x-button>
                </x-slot:footer>
            </x-modal>
                    ...
                    <form action="{{ route('admin-province.rtkdp.update', $rtkdp->id) }}" method="POST" id="uploadForm"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <x-form.input 
                                type="number" 
                                name="start_date" 
                                label="Berlaku Dari Tahun" 
                                :required="true" 
                                :value="$rtkdp->start_date" 
                                placeholder="2025" 
                            />
                            <x-form.input 
                                type="number" 
