                        ...
                        @forelse ($rtkds as $key => $rtkd)
                            <tr class="hover:bg-slate-50 transition">
                                ...
                                <td class="px-4 md:px-6 py-3 text-center">
                                    <x-table.action>
                                        @if (
                                            $rtkd->status != Modules\RTK\Enums\RTKStatus::APPROVED->value &&
                                                $rtkd->status != Modules\RTK\Enums\RTKStatus::EXPIRED->value)
                                            <li>
                                        ...
                                        @if (
                                            ...
                                            <li>
                                                <div
                                                    class="inline-flex items-center w-full p-2 hover:bg-slate-100 rounded">
                                                    <x-modal-delete :id="$rtkd->id"
                                                        message="Are you sure delete RTKD" :item-name="$rtkd->name"
                        ...
                        @empty
                            <tr class="">
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <p class="text-sm text-slate-500">Tidak ada data RTK</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
